            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-8 py-5 flex-auto">
                  <carouselSmall :items="carouselItemsSmall"></carouselSmall>
                </div>
              </div>
            </div>
        ...
        <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
          <div class="flex flex-wrap text-center justify-center">
            <div class="w-full lg:w-6/12 px-4">
              ...
              <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500">
                Put the potentially record low maximum sea ice extent this year down to the low ice. According to the National Oceanic and Atmospheric Administration, Ted, Scambos.
              </p>
            </div>
          </div>
          <div class="flex flex-wrap mt-12 justify-center">
            <div class="w-full lg:w-3/12 px-4 text-center">
              ...
              <h6 class="text-xl mt-5 font-semibold text-white">Excellent Services</h6>
...
export default {
  ...
  data() {
    return {
      carouselItems: [
        { imageUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1267&amp;q=80", altText: "Image 1" },
        { imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1051&amp;q=80", altText: "Image 2" },
        // Add more carousel items as needed
      ],
      carouselItemsSmall: [
        { imageUrl: "https://i.ibb.co/4RzH9Tj/abstract-nature-art-wallpaper.jpg", altText: "Image 1" },
        { imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1051&amp;q=80", altText: "Image 2" },
        // Add more carousel items as needed
      ],
    };
